...
// CHECK-NEXT:  	movups (%rcx,%r9,4),%xmm0
// CHECK-NEXT:  	movups 0x10(%rcx,%r9,4),%xmm4
// CHECK-NEXT:  	movups 0x20(%rcx,%r9,4),%xmm3
// CHECK-NEXT:  	movups 0x30(%rcx,%r9,4),%xmm1
// CHECK-NEXT:  	mov    $0xfffffffffffffffc,%r10
// CHECK-NEXT:  	mov    %r8,%r11
// CHECK-NEXT:  	cs nopw 0x0(%rax,%rax,1)
// CHECK-NEXT:  	nopl   0x0(%rax,%rax,1)
// CHECK-NEXT:  	movups -0xc00(%r11),%xmm6
// CHECK-NEXT:  	movups -0xbf0(%r11),%xmm7
// CHECK-NEXT:  	movups -0xbe0(%r11),%xmm8
// CHECK-NEXT:  	movups -0xbd0(%r11),%xmm9
...
// CHECK-NEXT:  	movups -0x800(%r11),%xmm9
// CHECK-NEXT:  	movups -0x7f0(%r11),%xmm4
// CHECK-NEXT:  	movups -0x7e0(%r11),%xmm3
// CHECK-NEXT:  	movups -0x7d0(%r11),%xmm1
...
// CHECK-NEXT:  	movups -0x3d0(%r11),%xmm9
// CHECK-NEXT:  	movups -0x3e0(%r11),%xmm8
// CHECK-NEXT:  	movups -0x3f0(%r11),%xmm7
// CHECK-NEXT:  	movups -0x400(%r11),%xmm6
...
// CHECK-NEXT:  	movups (%r11),%xmm5
// CHECK-NEXT:  	movups 0x10(%r11),%xmm4
// CHECK-NEXT:  	movups 0x20(%r11),%xmm3
// CHECK-NEXT:  	movups 0x30(%r11),%xmm1
...
// CHECK-NEXT:  	movups %xmm0,(%rcx,%r9,4)
// CHECK-NEXT:  	movups %xmm4,0x10(%rcx,%r9,4)
// CHECK-NEXT:  	movups %xmm3,0x20(%rcx,%r9,4)
// CHECK-NEXT:  	movups %xmm1,0x30(%rcx,%r9,4)
