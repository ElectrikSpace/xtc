...
// CHECK-NEXT:      linalg.fill {__node0__} ins(%cst : f32) outs(%arg2 : memref<256x256xf32>)
// CHECK-NEXT:      %alloc = memref.alloc() : memref<512x256xf32>
// CHECK-NEXT:      linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel"]} ins(%arg1 : memref<512x256xi8>) outs(%alloc : memref<512x256xf32>) attrs =  {__node1__} {
...
// CHECK-NEXT:      }
// CHECK-NEXT:      linalg.matmul {__node2__} ins(%arg0, %alloc : memref<256x512xf32>, memref<512x256xf32>) outs(%arg2 : memref<256x256xf32>)
