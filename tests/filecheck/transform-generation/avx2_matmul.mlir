...
// CHECK-NEXT:      transform.annotate %loops_3 "id1_i" : !transform.any_op
...
// CHECK-NEXT:      %4 = transform.structured.match attributes {id1_k1} in %3 : (!transform.any_op) -> !transform.any_op
