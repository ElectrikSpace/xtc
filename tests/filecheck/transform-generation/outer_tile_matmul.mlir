...
// CHECK-NEXT:      transform.annotate %loops_3 "id0_k" : !transform.any_op
...
// CHECK-NEXT:      transform.annotate %loops_5 "id0_i1" : !transform.any_op
...
// CHECK-NEXT:      transform.annotate %loops_7 "id0_k1" : !transform.any_op
...
// CHECK-NEXT:      %3 = transform.structured.match attributes {id0_i1} in %2 : (!transform.any_op) -> !transform.any_op
// CHECK-NEXT:      transform.loop.unroll %3 {factor = 8 : i64} : !transform.any_op
// CHECK-NEXT:      %4 = transform.structured.match attributes {id0_k1} in %2 : (!transform.any_op) -> !transform.any_op
