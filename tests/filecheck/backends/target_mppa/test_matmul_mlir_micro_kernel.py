...
# CHECK-NEXT:      %tiled_linalg_op, %loops = transform.structured.tile_using_for %2 tile_sizes [8, 0, 0] : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
...
# CHECK-NEXT:      transform.annotate %tiled_linalg_op_0 "xtc.request_vectorization" : !transform.any_op
...
# CHECK-NEXT:          %0 = "arith.constant"() <{value = 0.000000e+00 : f32}> : () -> f32
# CHECK-NEXT:          %1 = "arith.constant"() <{value = 0 : index}> : () -> index
# CHECK-NEXT:          %2 = "arith.constant"() <{value = 16 : index}> : () -> index
# CHECK-NEXT:          %3 = "arith.constant"() <{value = 8 : index}> : () -> index
# CHECK-NEXT:          "scf.for"(%1, %2, %3) ({
# CHECK-NEXT:          ^bb0(%arg4: index):
# CHECK-NEXT:            %4 = "memref.subview"(%arg0, %arg4) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: -9223372036854775808, 0>, static_sizes = array<i64: 8, 64>, static_strides = array<i64: 1, 1>}> : (memref<16x64xf32>, index) -> memref<8x64xf32, strided<[64, 1], offset: ?>>
# CHECK-NEXT:            %5 = "memref.subview"(%arg2, %arg4) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: -9223372036854775808, 0>, static_sizes = array<i64: 8, 16>, static_strides = array<i64: 1, 1>}> : (memref<16x16xf32>, index) -> memref<8x16xf32, strided<[16, 1], offset: ?>>
# CHECK-NEXT:            "scf.for"(%1, %2, %3) ({
# CHECK-NEXT:            ^bb0(%arg5: index):
# CHECK-NEXT:              %6 = "memref.subview"(%arg1, %arg5) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: 0, -9223372036854775808>, static_sizes = array<i64: 64, 8>, static_strides = array<i64: 1, 1>}> : (memref<64x16xf32>, index) -> memref<64x8xf32, strided<[16, 1], offset: ?>>
# CHECK-NEXT:              %7 = "memref.subview"(%5, %arg5) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: 0, -9223372036854775808>, static_sizes = array<i64: 8, 8>, static_strides = array<i64: 1, 1>}> : (memref<8x16xf32, strided<[16, 1], offset: ?>>, index) -> memref<8x8xf32, strided<[16, 1], offset: ?>>
# CHECK-NEXT:              "linalg.fill"(%0, %7) <{operandSegmentSizes = array<i32: 1, 1>}> ({
# CHECK-NEXT:              ^bb0(%arg9: f32, %arg10: f32):
# CHECK-NEXT:                "linalg.yield"(%arg9) : (f32) -> ()
# CHECK-NEXT:              }) : (f32, memref<8x8xf32, strided<[16, 1], offset: ?>>) -> ()
# CHECK-NEXT:              "linalg.matmul"(%4, %6, %7) <{indexing_maps = [#map, #map1, #map2], operandSegmentSizes = array<i32: 2, 1>}> ({
# CHECK-NEXT:              ^bb0(%arg6: f32, %arg7: f32, %arg8: f32):
# CHECK-NEXT:                %8 = "arith.mulf"(%arg6, %arg7) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
# CHECK-NEXT:                %9 = "arith.addf"(%arg8, %8) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
...
# CHECK-NEXT:        }) {mask = 1 : i32, nclusters = 1 : i32, npes_max = 1 : i32} : () -> ()
...
# CHECK-NEXT:  module attributes {transform.with_named_sequence} {
# CHECK-NEXT:    func.func @kvxcluster_launch_0_kernel_cc_0(%arg0: memref<16x64xf32, 2>, %arg1: memref<64x16xf32, 2>, %arg2: memref<16x16xf32, 2>) attributes {kernel_for_cluster_id = 0 : index} {
...
# CHECK-NEXT:        %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%0], sizes: [8, 64], strides: [64, 1] : memref<16x64xf32, 2> to memref<8x64xf32, strided<[64, 1], offset: ?>, 2>
# CHECK-NEXT:        scf.for %arg4 = %c0 to %c16 step %c8 {
# CHECK-NEXT:          %reinterpret_cast_0 = memref.reinterpret_cast %arg1 to offset: [%arg4], sizes: [64, 8], strides: [16, 1] : memref<64x16xf32, 2> to memref<64x8xf32, strided<[16, 1], offset: ?>, 2>
# CHECK-NEXT:          %1 = arith.muli %arg3, %c16 overflow<nsw> : index
# CHECK-NEXT:          %2 = arith.addi %1, %arg4 : index
# CHECK-NEXT:          %reinterpret_cast_1 = memref.reinterpret_cast %arg2 to offset: [%2], sizes: [8, 8], strides: [16, 1] : memref<16x16xf32, 2> to memref<8x8xf32, strided<[16, 1], offset: ?>, 2>
# CHECK-NEXT:          kvxpe.launch %arg5 (npes=1) {
# CHECK-NEXT:            scf.for %arg6 = %c0 to %c8 step %c1 {
# CHECK-NEXT:              scf.for %arg7 = %c0 to %c8 step %c1 {
# CHECK-NEXT:                memref.store %cst, %reinterpret_cast_1[%arg6, %arg7] : memref<8x8xf32, strided<[16, 1], offset: ?>, 2>
# CHECK-NEXT:              }
# CHECK-NEXT:            }
...
# CHECK-NEXT:        %0 = mppa.alloc : memref<16x64xf32, 2>
# CHECK-NEXT:        mppa.copy %arg0, %0 : memref<16x64xf32> to memref<16x64xf32, 2>
# CHECK-NEXT:        %1 = mppa.alloc : memref<16x16xf32, 2>
# CHECK-NEXT:        mppa.copy %arg2, %1 : memref<16x16xf32> to memref<16x16xf32, 2>
...
# CHECK-NEXT:          with (%0, %2, %1) : memref<16x64xf32, 2>, memref<64x16xf32, 2>, memref<16x16xf32, 2> {npes_max = 1 : i32}
# CHECK-NEXT:        kvxcluster.await_all
# CHECK-NEXT:        mppa.dealloc %2 : memref<64x16xf32, 2>
# CHECK-NEXT:        mppa.copy %1, %arg2 : memref<16x16xf32, 2> to memref<16x16xf32>
# CHECK-NEXT:        mppa.dealloc %1 : memref<16x16xf32, 2>
# CHECK-NEXT:        mppa.dealloc %0 : memref<16x64xf32, 2>
# CHECK-NEXT:        kvxcluster.await_all
# CHECK-NEXT:      }
# CHECK-NEXT:      return
# CHECK-NEXT:    }
